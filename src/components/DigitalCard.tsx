...
export default function DigitalCard({ title, description }: DigitalCardProps) {
  return (
    <div
      ...
      style={{
        width: "440px",
        height: "550px",
        clipPath: "polygon(10% 0, 100% 0, 90% 100%, 0 100%)", // Parallelogram: edges parallel to adjacent cards
        marginLeft: "-20px",
        marginRight: "-20px",
      }}
    >
      ...
      <div className="w-full h-full relative overflow-hidden bg-[#FF7562] shadow-[0_18px_45px_rgba(0,0,0,0.3)]">
        ...
        <div className="w-full h-[340px] flex items-center justify-center">
          <img src={Solution} alt={title} className="w-full h-full object-cover" />
        </div>
